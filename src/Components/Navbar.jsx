      ...
      <div className=' bg-neutral-900 text-neutral-100 text-xl font-notosans h-20 flex justify-between items-center relative w-[100%]'>
        <div className='sm:w-[55%] flex justify-between w-[90%] sm:text-xl text-sm'>
          ...
          <div className='absolute'>
            <button
              className={`fixed z-40 right-10 sm:top-10 top-8 cursor-pointer ${isOpen ? `text-neutral-900 text-3xl` : `text-neutral-100 text-3xl`}`}
              onClick={toggleMenu}
            >
              {isOpen ? <span class='material-symbols-outlined md-72'>close</span> : <span className='material-symbols-outlined md-72'>menu</span>}
            </button>
            <AnimatePresence>
              {isOpen && (
                <motion.div
