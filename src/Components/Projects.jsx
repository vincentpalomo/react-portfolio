...
const Projects = () => {
      ...
      element: (
        <div className="flex justify-between w-[22rem] sm:w-[600px]">
          ...
          <div className="flex sm:space-x-5 space-x-2 font-playfair">
            ...
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a
                href="https://github.com/vincentpalomo/phenomena"
                target="_blank"
                rel="noreferrer"
                className="hover:text-purple-500"
              >
      ...
      element: (
        <div className="flex justify-between w-[22rem] sm:w-[600px]">
          ...
          <div className="flex sm:space-x-5 space-x-2 font-playfair">
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a
                href="https://abbymorgan.vercel.app/"
                target="_blank"
                rel="noreferrer"
                className="hover:text-purple-500"
              >
      ...
      element: (
        <div className="flex justify-between w-[22rem] sm:w-[600px]">
          ...
          <div className="flex sm:space-x-5 space-x-2 font-playfair">
            ...
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a
                href="https://github.com/vincentpalomo/lucid_studio"
                target="_blank"
                rel="noreferrer"
                className="hover:text-purple-500"
              >
  ...
  return (
    <div className="relative min-h-screen bg-neutral-900 flex flex-col justify-center items-center">
      ...
      >
        <svg
          className="sm:h-[15rem] md:h-[12rem] lg:h-[15rem] xl:h-[20rem] h-[16rem]"
          viewBox="0 0 500 500"
          x="0px"
          y="0px"
        >
          ...
          <path
            fill="#F5F5F5"
            d="M154.484,266.017c-5.384,1.167-3.785,9.2,1.636,8.22C161.5,273.07,159.9,265.034,154.484,266.017Z"
          />
          <path
            fill="#F5F5F5"
            d="M171.381,95.639c5.384-1.167,3.785-9.2-1.636-8.221C164.361,88.585,165.961,96.622,171.381,95.639Z"
          />
          <path
            fill="#F5F5F5"
            d="M170.706,108.149c-5.384,1.166-3.785,9.2,1.635,8.22C177.725,115.2,176.126,107.165,170.706,108.149Z"
          />
          <path
            fill="#F5F5F5"
            d="M172.341,138.908c5.384-1.167,3.785-9.2-1.635-8.221C165.322,131.854,166.921,139.891,172.341,138.908Z"
          />
          <path
            fill="#F5F5F5"
            d="M171.169,152.66c-5.384,1.167-3.785,9.2,1.635,8.22C178.188,159.713,176.589,151.677,171.169,152.66Z"
          />
          <path
            fill="#F5F5F5"
