...
const Projects = () => {
        ...
        <div className='flex justify-between sm:w-[600px]'>
          ...
          <div className='flex sm:space-x-5 space-x-2 font-playfair'>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <motion.a href='https://valorant-react-vp.netlify.app/' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                live
              </motion.a>
            </motion.div>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://github.com/vincentpalomo/Valorant-React-App' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                github
              </a>
            </motion.div>
          </div>
    ...
    },
    {
      ...
      element: (
        <div className='flex justify-between w-[22rem] sm:w-[600px]'>
          ...
          <div className='flex sm:space-x-5 space-x-2 font-playfair'>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://abbymorgan.netlify.app/' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                live
              </a>
            </motion.div>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://github.com/vincentpalomo/abby-morgan-portfolio' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                github
              </a>
            </motion.div>
          </div>
    ...
    },
    {
      ...
      element: (
        <div className='flex justify-between sm:w-[600px]'>
          ...
          <div className='flex sm:space-x-5 space-x-2 font-playfair'>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://codethreads.netlify.app/home' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                live
              </a>
            </motion.div>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://github.com/CodeThreads-FSA-VP-AM/CodeThreads' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                github
              </a>
            </motion.div>
          </div>
    ...
    },
    {
      ...
      element: (
        <div className='flex justify-between sm:w-[600px]'>
          ...
          <div className='flex sm:space-x-5 space-x-2 font-playfair'>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://fitnesstrakr-fsa-vp-at.netlify.app/' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                live
              </a>
            </motion.div>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://github.com/anahuynh27/FitnessTracker_FrontEnd' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                github
              </a>
            </motion.div>
          </div>
...

    {
      ...
      element: (
        <div className='flex justify-between sm:w-[600px]'>
          ...
          <div className='flex sm:space-x-5 space-x-2 font-playfair'>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <motion.a href='https://caeser-cipher-react.netlify.app/' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                live
              </motion.a>
            </motion.div>
            <motion.div initial={{ scale: 1 }} whileHover={{ scale: 1.2 }}>
              <a href='https://github.com/vincentpalomo/caeser-cipher-react' target='_blank' rel='noreferrer' className='hover:text-purple-500'>
                github
              </a>
            </motion.div>
          </div>
  ...
  return (
    <div className='relative min-h-screen bg-neutral-900 flex flex-col justify-center items-center'>
      ...
      >
        <svg className='sm:h-[15rem] md:h-[12rem] lg:h-[15rem] xl:h-[20rem] h-[16rem]' viewBox='0 0 500 500' x='0px' y='0px'>
          <path
            fill='#F5F5F5'
      ...
      <motion.div
        ...
        className='flex flex-col justify-start sm:space-y-3 md:space-y-5 space-y-3 font-notosans tracking-wide lowercase sm:text-3xl md:text-5xl text-[1.5rem] text-neutral-100 sm:w-[50%] absolute top-60 sm:top-72 sm:right-96'
      >
