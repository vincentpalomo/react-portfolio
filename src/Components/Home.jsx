    ...
    <>
      <Element id="home" name="home">
        <div className="relative h-screen bg-neutral-900 flex justify-center items-center text-9xl font-playfair text-neutral-100">
          ...
          <Link className="text-8xl mx-20 sm:mx-0 sm:text-[13rem] tracking-tight absolute sm:top-32 top-20" to="/">
          ...
          <motion.div
            ...
            className="absolute sm:bottom-10 bottom-28"
          >
            <svg className="h-96" viewBox="0 0 500 625" x="0px" y="0px">
              <path
                fill="#F5F5F5"
                d="M254.963,169.094c4.664-3.232-.026-10.249-4.8-7.177C245.5,165.149,250.193,172.166,254.963,169.094Z"
              />
              <path
                fill="#F5F5F5"
                d="M347.08,11.916c4.664-3.233-.026-10.25-4.8-7.178C337.62,7.971,342.31,14.988,347.08,11.916Z"
              />
              <path
                fill="#F5F5F5"
          ...
          <motion.div
            ...
            transition={{ duration: 1, delay: 1.5 }}
            className="absolute sm:bottom-5 sm:left-10 bottom-16 lowercase tracking-tight font-notosans text-lg"
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 1, delay: 1.5 }}
            className="absolute sm:bottom-5 bottom-9 sm:right-10 text-lg"
          >
